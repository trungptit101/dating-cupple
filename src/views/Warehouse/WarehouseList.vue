<template>
  <c-page-container class="product" title="Danh sách kho hàng">
    <div class="product__content p-16 rounded-sm">
      ...
      >
        <el-input
          ...
          v-model="filter.key"
          placeholder="Tên hoặc mã kho hàng"
        >
          <template #prefix>
        ...
        <e-select
          ...
          item-value="value"
          item-label="label"
          v-model="filter.persionInChargeId"
          class="product__filter__item mr-8 mb-8"
...
import WarehouseTable from '@/components/Pages/Warehouse/WarehouseTable.vue'
